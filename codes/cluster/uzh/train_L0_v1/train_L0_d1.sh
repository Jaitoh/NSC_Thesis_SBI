...
#SBATCH --output=./cluster/train_L0/train_L0_d1.out ## standard out file 
...
--log_dir './src/train/logs/log-simulator_Ca_Pb_Ma-dataset_Sb0_suba1_Rc0-train_Ta1' \
> ./cluster/train_L0/train_L0_d1.log
# --gpu \
