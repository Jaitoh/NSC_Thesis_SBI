...
#SBATCH --output=./cluster/train_L0/train_L0_c6.out ## standard out file 
...
--log_dir './src/train/logs/log-simulator_Ca_Pb_Ma-dataset_Sa0_suba0_Rb0-train_Ta1' \
-y > ./cluster/train_L0/train_L0_c6.log
# --gpu \
