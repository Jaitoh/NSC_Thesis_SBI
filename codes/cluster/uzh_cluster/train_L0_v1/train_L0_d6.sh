...
#SBATCH --output=./cluster/train_L0/train_L0_d6.out ## standard out file 
...
--config_dataset_path './src/config/dataset_Sa0_suba0_Rc0.yaml' \
--config_train_path './src/config/train_Ta1.yaml' \
--log_dir './src/train/logs/log-simulator_Ca_Pb_Ma-dataset_Sa0_suba0_Rc0-train_Ta1' \
> ./cluster/train_L0/train_L0_d6.log
# --gpu \
