...
#SBATCH --output=./cluster/train_L0/train_L0_b2.out ## standard out file 
...
--config_dataset_path './src/config/dataset_Sb0_suba1_Ra1.yaml' \
--config_train_path './src/config/train_Ta1.yaml' \
--log_dir './src/train/logs/log-simulator_Ca_Pb_Ma-dataset_Sb0_suba1_Ra1-train_Ta1' \
--gpu \
> ./cluster/train_L0/train_L0_b2.log
