...
#SBATCH --job-name=prior_sim_15
#SBATCH --output=./cluster/uzh/prior_sim/prior_sim_15_%a.out
#SBATCH --error=./cluster/uzh/prior_sim/prior_sim_15_%a.err
...
python3 -u ./src/analysis/prior_range_15.py --dur_list [15] --task_part [${alpha},${gamma}]
