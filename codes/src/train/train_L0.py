...
from utils.setup import (
    check_path,
    get_args,  # get_args_run_from_code
)

# from utils.resource import monitor_resources
from train.Dataset_Classes import collate_fn_vec, collate_fn_vec_high_dim
...
class Solver:
    ...
    def get_my_data_kwargs(self):
        ...
        is_3_dim_dataset = (
            self.config.train.density_estimator.embedding_net.type
            in self.config.train.density_estimator.embedding_net.embedding_net_use_3_dim_dataset
        )
