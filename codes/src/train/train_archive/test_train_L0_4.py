...
x_dir = Path('../data/training_datasets/x_test.pt') if test else Path('../data/training_datasets/x_15_4.pt')
theta_dir = Path('../data/training_datasets/theta_test.pt') if test else Path('../data/training_datasets/theta_15_4.pt')
...
log_dir = Path('./src/train/logs_15_p0/log_test') if test else Path('./src/train/logs_15_p0/log_sample_Rchoices4')
