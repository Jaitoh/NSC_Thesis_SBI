...
x_dir = Path('../data/training_datasets/x_test.pt') if test else Path('../data/training_datasets/x_15_5.pt')
theta_dir = Path('../data/training_datasets/theta_test.pt') if test else Path('../data/training_datasets/theta_15_5.pt')
