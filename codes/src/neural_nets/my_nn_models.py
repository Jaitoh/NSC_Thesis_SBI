...
from neural_nets.cnle.build_cnle import build_cnle


def my_likelihood_nn(
    model: str,
    ...
    **kwargs,
    ...
    def build_fn(batch_theta, batch_x):
        if model == "cnle":
            return build_cnle(batch_x=batch_x, batch_y=batch_theta, **kwargs)
        else:
