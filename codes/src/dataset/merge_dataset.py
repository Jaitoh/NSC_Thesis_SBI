...
parser.add_argument(
    "--data_dir",
    type=str,
    default="/home/wehe/scratch/data/dataset/v2",
    help="simulated data store/load dir",
)
parser.add_argument(
    "--merged_data_path",
    type=str,
    default="/home/wehe/scratch/data/dataset-L0-Eset0-100sets-T500v2.h5",
)
...
for data_file in files:
    ...
    data_file_idxs.append(int(data_path.split("part_")[-1].split(".")[0]))
