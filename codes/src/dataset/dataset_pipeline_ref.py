...
from dataset.seqC_pR_process import seqC_pattern_summary
...
def prepare_training_data_from_sampled_Rchoices(
    ...
    print(f'prior_sample_size: {prior_sample_size}, seqC_sample_size: {seqC_sample_size}')
    ...
    print(f'single_dur_seqC_shape: {single_dur_seqC_shape}, single_dur_theta_shape: {single_dur_theta_shape}')
