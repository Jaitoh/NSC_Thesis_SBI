./gdrive files upload "./tmp/NSC/data/training_datasets/training_dataset.hdf5"
./gdrive files upload "./tmp/NSC/data/datasets/sim_data_Ca_Pb_Ma.h5"
# ./gdrive files upload "./tmp/NSC/data/training_datasets/x.pt"
# ./gdrive files upload "./tmp/NSC/data/training_datasets/theta.pt"
# ./gdrive files list
# from file to folder
# ./gdrive files move 1MiVw4EZvHS9bzRjnS801QZ46VKnHDa43 113vN2S7Ip2PTdHZggA3zNcLWOfBtEisw
# ./gdrive files move 1Dln5ebWNmkdPTifHPDfPtvRdhxnyFJtw 1p8VllVRsIvKcsmrwmfy9_drI1w0hADv8

# upload prior huge simulation results
./gdrive files upload "/home/wehe/scratch/data/prior_sim_probR_dur_11.tar.gz" # file id 1BqVrU_bbD29346t3ttfaCmbIsQutYSH5
./gdrive files upload "/home/wehe/scratch/data/prior_sim_probR_dur_13.tar.gz" # file id 141LcJ5Sj-IkvYvaxvVrtbW0vRZ0-kwMD
./gdrive files upload "/home/wehe/scratch/data/prior_sim_probR_dur_15.tar.gz" # file id 1jVfHONCf_TQN552A9BOq5UkMThA_9Xmh parents 0AJ5S4vU0HypcUk9PVA

# folder for prior_sim: 1VXyrQjCeoqvEl8dllXRvhHAf27SJpEMq
...
./gdrive files move 1bcv3Nxh7nFBMbD5_6lThYQcFdFQlg0zV 1xn4xcEtxLGwBqXyFP9p48CrEqGeymD8U
